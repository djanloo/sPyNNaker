...
# These are standard
echoline CLONING
pecho started cloning stage at $(date)
git clone https://github.com/SpiNNakerManchester/SpiNNUtils.git
git clone https://github.com/SpiNNakerManchester/spinnaker_tools.git &> /tmp/last_git.tmp
git clone https://github.com/NeuralEnsemble/PyNN.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/SpiNNMachine.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/SpiNNStorageHandlers.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/PACMAN.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/SpiNNMan.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/DataSpecification.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/spalloc.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/spinn_common.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/spalloc_server.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/SpiNNFrontEndCommon.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/sPyNNaker8.git &> /tmp/last_git.tmp
git clone https://github.com/SpiNNakerManchester/JavaSpiNNaker.git &> /tmp/last_git.tmp

pecho WARNING: some packages of the installation chain were not updated due to the 17-JUL-23 update


# waits the end of downloads
wait
